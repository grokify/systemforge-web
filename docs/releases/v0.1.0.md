...
SystemForge Web is a React component library monorepo designed for building multi-tenant SaaS applications. It provides a complete set of primitives for authentication, multi-tenancy, telemetry, and UI components.
...
This release includes comprehensive ProductGraph integration in `@systemforge/telemetry`:
...
git clone https://github.com/grokify/systemforge-web.git
cd systemforge-web
